...
- **Per-teacher quirk handlers:**
  - **Dana Bengali `additionalContext`.** Read `student.fields.needsBengali`
  ...
  - **Robin journal method.** When an activity starts with
  ...
  - **Robin Spanish post-streamline append.** If `student.fields.needsSpanish`,

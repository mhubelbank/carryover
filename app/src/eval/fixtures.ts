...
export const FIXTURES: Fixture[] = [
  {
    ...
    ctx: ctxFor(
      ...
      "Sam read a short passage and answered comprehension questions about it.",
    ),
  },
  {
  ...
  },
  {
    ...
    ctx: ctxFor(
      ...
      "Theo answered questions about a passage, then sequenced picture cards to retell it.",
    ),
  },
];
